...
//  * Question 1
//  * Given a variable color with a value "red", use a switch statement to set
// a variable feeling to "passionate" for "red", "calm" for "blue", and "neutral" for other colors.
const color = "red";
let feeling;
...
// * Question 2
//  * Using a switch statement, check the value of the variable day (e.g., "Monday").
//  Return "Working day" for weekdays and "Weekend" for Saturday and Sunday.
const day = "Monday";
switch (day) {
  case "Monday":
  case "Tuesday":
...
//  * Question 3
//  * Given a variable score of 85, set a grade: "A" for 90 and above, "B" for 80-89,
...
// Set "berry" for strawberries, blueberries, and raspberries. "Not a berry" for other fruits.
const fruits = "berry";
switch (fruits) {
  case "strawberry":
  case "blueberry":
...
//  * Question 5
//  * Check the value of the variable month (e.g., "January")
// and return which quarter of the year it belongs to.
...
//  * Question 6
//  * Use a switch statement to determine if a number is "small", "medium", or "large".
//  Consider numbers 1-3 as "small", 4-6 as "medium", and 7-9 as "large".
...
//  * Question 7
//  * Determine the type of the variable pet (e.g., "dog"). Return "Canine" for a dog,
//  "Feline" for a cat, and "Unknown" for other pets.
let pet;
switch (pet) {
  case pet === "dog":
...
//  * Question 8
//  * Given a variable transportMode with a value like "car", return "Fast" for "plane",
// "Medium" for "car", and "Slow" for "bicycle".
...
//  * Question 9
//  * For a variable direction with values like "N", determine the full direction name.
...
//  * Question 10
//  * Determine the type of drink based on the variable drink. "Water" for "H2O",
//  "Coffee" for "C8H10N4O2", and "Unknown" for other values.
const drink = "Water";
switch (drink) {
  case "Water":
    console.log("([Question 10]):", "H2O");
    break;
  case "Coffee":

...
for (let i = 0; i < name1.length; i++) {
  ...
  if (name1[i].toLowerCase() === "a") {
    //   the ones you find apart
    count1++;
  }
}
console.log("[Question 1]: ", count1); // Answer should be:
// console.log("string array" , name1[name1.length - 1; este menos 1
// me permite saber la ultima posición del array.
...
for (let l = 0; l < books4.length; l++) {
  // Your code here
  //   tomamos primer carton y lo ponemos al principio
  bookString4 += books4[1];
  if (1 < books4.length - 1) bookString4 += ",";
}
// añadir carton con coma
// añadir siguiente carton con palabra
...
for (let m = 0; m < name5.length; m++) {
  // Your code here
  // if(
  // name 5[m]==="a" || name5[m]  === "e" ||  name 5[m] === "i" ||
  // name5 [m] === "o"  ||  name5[m] === "u" ) {
  // count5++
  // }
...
for (let o = 0; o < story7.length; o++) {
  ...
  if (o < story7.length - 1) storyString7 += " ";
}
console.log("[Question7] ", storyString7); // Answer should be:
...
console.log("[Question8]: ", acronym8.toUpperCase()); // Answer should be:
...
console.log("[Question9]: ", upperName9); // Answer should be:
...
console.log("[Question10]: ", length10); // Answer should be:
...
console.log("[Question11]: ", count11); // Answer should be:
...
console.log("[Question12]: ", reversedTown12); // Answer should be:
...
console.log("[Question13]: ", sum13); // Answer should be:
...
console.log("[Question14]: ", apostlesString14); // Answer should be:
...
console.log("[Question15]: ", count15); // Answer should be:
...
console.log("[Question16]: ", product16); // Answer should be:
...
for (let y = 0; y < story17.length; y++) {
  ...
  if (y < story17.length - 1) storyString17 += " ";
}
console.log("[Question17]: ", storyString17); // Answer should be:
...
console.log("[Question19]: ", lowerName19); // Answer should be:
...
console.log("[Question20]: ", length20); // Answer should be:
